...
import io.spotnext.beansy.processor.DataBeanProcessor;

import static com.google.testing.compile.JavaSourcesSubject.assertThat;
import static io.spotnext.beansy.processor.DataBeanProcessor.MISSING_SERVICES_ERROR;

/**
 * Tests the {@link DataBeanProcessor}.
 */
@RunWith(JUnit4.class)
public class DataBeanProcessorTest {
	@Test
	public void autoService() {
		assertThat(
				...
				JavaFileObjects.forResource("test/AnotherServiceProvider.java"))
						.processedWith(new DataBeanProcessor())
