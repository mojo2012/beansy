package io.spotnext.beansy.processor;
...
import io.spotnext.beansy.annotations.Data;

/**
 * Processes {@link Data} annotations and generates java beans.
 * <p>
 * Processor Options:
 * <ul>
...
public class DataBeanProcessor extends AbstractProcessor {
	...
	public static final Set<Class<? extends Annotation>> SUPPORTED_ANNOTATIONS = Set.of(Data.class);
